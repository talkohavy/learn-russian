...
import DownArrow from '@src/utils/svgs/DownArrow';
...
export default function Sidebar() {
  ...
  return (
    <nav
      className={clsx(
        'relative flex h-full flex-col items-start justify-start bg-amber-50 shadow-md transition-all duration-300 dark:bg-slate-500',
        isSidebarOpen ? 'w-48 p-10' : 'w-1 p-0',
      )}
    >
      <button
        type='button'
